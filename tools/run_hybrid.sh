...
RETRIEVAL_FUSION="${RETRIEVAL_FUSION:-quota}"
FUSION_MEAN_TOPK="${FUSION_MEAN_TOPK:-32}"
FUSION_TOKEN_TOPK="${FUSION_TOKEN_TOPK:-32}"
...
RUNS=(
  "retrieval_fusion_head_specific_true::--kv_repr mean --q_repr mean --k_token_agg topk --k_topk_ratio 0.1 --q_token_agg topk --q_topk_ratio 0.3"
)
...
run_one() {
  ...
  echo "Fusion=${RETRIEVAL_FUSION} mean_topk=${FUSION_MEAN_TOPK} token_topk=${FUSION_TOKEN_TOPK}"
  echo "============================================================"
